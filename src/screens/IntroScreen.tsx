...
export const IntroScreen: React.FC<NativeStackScreenProps<RootStackParamList, 'Intro'>> = ({ navigation }) => {
    ...
    <View style={styles.container}>
      ...
      {!hatched ? (
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.meta}>{character?.role} • {character?.rarity}★</Text>
